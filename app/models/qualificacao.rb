...
class Qualificacao < ApplicationRecord
  ...
  validates_numericality_of :nota, greater_than_or_equal_to: 0, less_than_or_equal_to: 10, message: " - deve ser um n\xC3\xBAmero entre 0 e 10"

  validates_numericality_of :valor_gasto, greater_than: 0, message: " - deve ser um n\xC3\xBAmero maior que 0"
